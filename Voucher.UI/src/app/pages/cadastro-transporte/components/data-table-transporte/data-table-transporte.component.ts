...
@Component({
  selector: 'app-data-table-transporte',
  templateUrl: './data-table-transporte.component.html',
  styleUrls: ['./data-table-transporte.component.scss']
})
export class DataTableTransporteComponent implements OnInit, OnChanges, AfterViewInit {

...
@Component({
  selector: 'app-data-table-alimentacao',
  templateUrl: './data-table-alimentacao.component.html',
  styleUrls: ['./data-table-alimentacao.component.scss']
})
export class DataTableAlimentacaoComponent implements OnInit, OnChanges, AfterViewInit {
  mealType = MealType;
